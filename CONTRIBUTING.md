...
We're working hard to make *luxcore* the most powerful JavaScript library for working with lux. Our goal is to have *luxcore* be a library that can be used by anyone interested in lux, and to level expertise differences with great design and documentation.
...
```sh
git remote add lux-core git@github.com:lux-core/luxcore.git
git pull --rebase lux-core master
```
...
```
Finally go to [github.com/lux-core/luxcore](https://github.com/lux-core/luxcore) in your web browser and issue a new pull request.
...
[github.com/lux-core/luxcore/issues](https://github.com/lux-core/luxcore/issues).
